...
group_name = {
  ...
  --CS graphics
  ["DanceDanceRevolution HOTTEST PARTY 1"] ={"57 - HOTTEST PARTY 1","light blue","Version/CS DDR HOTTEST PARTY","#85fbff"};
  ["DanceDanceRevolution HOTTEST PARTY 2"] ={"58 - HOTTEST PARTY 2","light blue","Version/CS DDR HOTTEST PARTY 2","#85fbff"};
  ["DanceDanceRevolution HOTTEST PARTY 3"] ={"59 - HOTTEST PARTY 3","purple","Version/CS DDR HOTTEST PARTY 3","#8985ff"};
  ["DanceDanceRevolution CS Wii"] = 		{"60 - DDR CS WII","pink","Version/CS DDR WII","#eb8bc8"};
  ["DanceDanceRevolution HOTTEST PARTY 4"] ={"60 - HOTTEST PARTY 4","pink","Version/CS DDR HOTTEST PARTY 4","#eb8bc8"};
  ["DanceDanceRevolution CS Wii II"] = 		{"61 - DDR CS 2","dark blue","Version/CS DDR WII II","#001aff"};
  ["DanceDanceRevolution HOTTEST PARTY 5"] ={"61 - HOTTEST PARTY 5","dark blue","Version/CS DDR HOTTEST PARTY 5","#001aff"};
  --Bemani sort
